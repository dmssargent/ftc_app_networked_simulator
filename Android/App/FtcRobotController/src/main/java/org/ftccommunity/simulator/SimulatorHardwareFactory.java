 ...
 */
public class SimulatorHardwareFactory extends HardwareFactory {
    private Context context;

    public SimulatorHardwareFactory(Context context) {
        super(context);
    ...
    public HardwareMap createHardwareMap(EventLoopManager manager) throws RobotCoreException, InterruptedException {
        ...
        synchronized (HardwareDeviceManager.scanDevicesLock) {
            ...
            if (xmlPullParser != null) {
                DeviceManager deviceMgr = new SimulatorHardwareDeviceManager(context, manager);
